...
OPTIONAL {
 ...
 OPTIONAL {
  ...
  # replaces, follows, part of the series
  OPTIONAL {
   ?item wdt:P1365|wdt:P155|wdt:P179 ?predecessor .  
  ...
  # replaced by, followed by, has parts(s)
  OPTIONAL {
   ?item wdt:P1366|wdt:P156|wdt:P527 ?successor .  
