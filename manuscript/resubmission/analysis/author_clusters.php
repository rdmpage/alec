...
$raw_counts[json_encode(array('ipni total'))] = $count;
...
$raw_counts[json_encode(array('ipni only'))] = $count;
...
$count = get_count($sparql);
$raw_counts[json_encode(array('bhl total'))] = $count;
...
$raw_counts[json_encode(array('bhl only'))] = $count;
...
$count = get_count($sparql);
$raw_counts[json_encode(array('zoobank total'))] = $count;
...
$raw_counts[json_encode(array('zoobank only'))] = $count;
...
$count = get_count($sparql);
$raw_counts[json_encode(array('wikispecies total'))] = $count;
...
$raw_counts[json_encode(array('wikispecies only'))] = $count;
...
$raw_counts[json_encode(array('bhl', 'ipni', 'zoobank'))] = $count;
...
$raw_counts[json_encode(array('bhl', 'wikispecies', 'zoobank'))] = $count;
...
$raw_counts[json_encode(array('ipni', 'wikispecies', 'zoobank'))] = $count;
...
$raw_counts[json_encode(array('bhl', 'ipni', 'wikispecies', 'zoobank'))] = $count;
